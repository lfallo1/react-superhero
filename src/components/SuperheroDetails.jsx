...
var SuperheroDetails = React.createClass({
      render : function(){
        ...
        var renderDetails = function(){
          if(superhero.name){
            var description = superhero.level > 9000 ? superhero.name + ' is pretty damn strong!' : superhero.level > 7000 ? superhero.name + ' is quite a powerful superhero' : superhero.name + ' is just okay';
            return (
